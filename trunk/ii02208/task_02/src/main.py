...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.layout.addWidget(self.button_find, 5, 0)
        self.layout.addWidget(self.button_save, 6, 0)
        self.layout.addWidget(self.button_load, 7, 0)
        self.layout.addWidget(self.button_export, 8, 0)
        self.layout.addWidget(self.list, 2, 1, 7, 1)
